...
/* Define the driver capability for hardware checksum offload.  */
...
typedef struct NX_DRIVER_INFORMATION_STRUCT
{
    ...
    /****** DRIVER SPECIFIC ****** Start of part/vendor specific driver information area.  */
...
/****** DRIVER SPECIFIC ****** Start of part/vendor specific external function prototypes.  */
