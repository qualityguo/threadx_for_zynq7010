...
/*##################################################################### */
    ...
    * Fractional value for the Feedback value.
    *  PSU_CRF_APB_APLL_FRAC_CFG_DATA                              0xa3d

    * Fractional control for the PLL
    * (OFFSET, MASK, VALUE)      (0XFD1A0028, 0x8000FFFFU ,0x80000A3DU)
    */
	PSU_Mask_Write(CRF_APB_APLL_FRAC_CFG_OFFSET,
		0x8000FFFFU, 0x80000A3DU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * This register controls this reference clock
    * (OFFSET, MASK, VALUE)      (0XFD1A007C, 0x013F3F07U ,0x01013800U)
    */
